...
def upgrade() -> None:
    ...
    op.create_table('chats_types',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_chats_types_id'), 'chats_types', ['id'], unique=False)
    ...
    sa.Column('title', sa.String(), nullable=True, comment='Если type group - название чата'),
